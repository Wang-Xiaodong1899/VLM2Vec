...
OUTPUT_BASEDIR=exps/vlm2vec_f32_video_ret_1_g4
...
for spec in "${MODEL_SPECS[@]}"; do
  ...
  for MODALITY in "${MODALITIES[@]}"; do
    ...
    cmd="CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES torchrun --nproc_per_node=4 --master_port=2233 --max_restarts=0 eval.py \
      --pooling eos \
      --normalize true \
